...
- Reference Site: https://www.buick.com/
- Mock up provided by GM team
  ![image](https://github.com/user-attachments/assets/0a342507-e47c-4323-99e0-d2fe1a65bb5f)


## Environments
- Preview: https://main--general-motors--adobedevxsc.aem.page/
- Live: https://main--general-motors--adobedevxsc.aem.live/
...
1. Open the `general-motors` directory in your favorite IDE and start coding :)
