...
export default async function decorate(block) {
  const aemauthorurl = 'https://author-p128352-e1258333.adobeaemcloud.com';
  // const aempublishurl = 'https://publish-p128352-e1258333.adobeaemcloud.com';
  ...
  const url = `${aemauthorurl}${persistedquery};path=${contentPath};variation=${variationname};ts=${Math.random() * 1000}`;
  ...
  <div class='block' data-aue-resource='${itemId}' data-aue-label='Teaser' data-aue-type='reference' data-aue-filter='cf'>
    <div class='card-body-content'>
      <p data-aue-prop='pretitle' data-aue-label='Pre-Title' data-aue-type='text' class='pretitle'>${cfReq?.pretitle}</p>
      <h2 data-aue-prop='title' data-aue-label='Title' data-aue-type='text' class='title'>${cfReq?.title}</h2>
      <p data-aue-prop='description' data-aue-label='Description' data-aue-type='richtext' class='description'>${cfReq?.description?.plaintext}</p>
